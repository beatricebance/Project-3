  ...
  setWidth(width: number): void {
    ...
    if (this.rectangle) {
      this.renderer.setAttribute(
        this.rectangle,
        "width",
        this.rectangleAttributes.width.toString() + "px"
      );
    }
  }
  ...
  setHeight(height: number): void {
    ...
    if (this.rectangle) {
      this.renderer.setAttribute(
        this.rectangle,
        "height",
        this.rectangleAttributes.height.toString() + "px"
      );
    }
  }
  ...
  setX(x: number): void {
    ...
    if (this.rectangle) {
      this.renderer.setAttribute(
        this.rectangle,
        "x",
        this.rectangleAttributes.x.toString() + "px"
      );
    }
  }
  ...
  setY(y: number) {
    ...
    if (this.rectangle) {
      this.renderer.setAttribute(
        this.rectangle,
        "y",
        this.rectangleAttributes.y.toString() + "px"
      );
    }
  }
  ...
  execute(): void {
    if (!this.rectangle) {
      ...
      this.renderer.setStyle(
        this.rectangle,
        "stroke-width",
        this.rectangleAttributes.strokeWidth.toString() + "px"
      );
      this.renderer.setStyle(
        this.rectangle,
        "fill",
        this.rectangleAttributes.fill
      );
      this.renderer.setStyle(
        this.rectangle,
        "stroke",
        this.rectangleAttributes.stroke
      );
      this.renderer.setStyle(
        this.rectangle,
        "fillOpacity",
        this.rectangleAttributes.fillOpacity
      );
      this.renderer.setStyle(
        this.rectangle,
        "strokeOpacity",
        this.rectangleAttributes.strokeOpacity
      );
    }
