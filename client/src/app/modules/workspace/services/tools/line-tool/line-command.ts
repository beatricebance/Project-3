...
export class LineCommand implements ICommand {
  ...
  finishLine(isLoopLine: boolean): void {
    if (isLoopLine) {
      this.lineAttributes.pointsList[
        this.lineAttributes.pointsList.length - 1
      ] = this.lineAttributes.pointsList[0];
    } else {
      this.lineAttributes.pointsList.pop();
    }
    if (this.line) {
  ...
  execute(): void {
    if (!this.line) {
      ...
      this.renderer.setStyle(
        this.line,
        "fillOpacity",
        this.lineAttributes.fillOpacity
      );
      this.renderer.setStyle(
        this.line,
        "strokeWidth",
        this.lineAttributes.strokeWidth.toString() + "px"
      );
      this.renderer.setStyle(
        this.line,
        "strokeOpacity",
        this.lineAttributes.strokeOpacity
      );
      this.renderer.setStyle(
        this.line,
        "stroke-linecap",
        this.lineAttributes.strokeLinecap
      );
      this.renderer.setStyle(
        this.line,
        "stroke-linejoin",
        this.lineAttributes.strokeLinejoin
      );
      this.renderer.setStyle(
        this.line,
        "stroke-dasharray",
        this.lineAttributes.strokeDasharray + "px"
      );
      ...
      if (this.lineAttributes.markerVisibility === "visible") {
        ...
        this.renderer.setAttribute(
          marker,
          "markerHeight",
          this.lineAttributes.diameter.toString() + "px"
        );
        this.renderer.setAttribute(
          marker,
          "markerWidth",
        ...
        this.renderer.setAttribute(
          marker,
          "refX",
          (this.lineAttributes.diameter / 2).toString() + "px"
        );
        this.renderer.setAttribute(
          marker,
          "refY",
        ...
        this.renderer.setProperty(
          marker,
          "id",
          `${this.lineAttributes.diameter}-Marker-${this.lineAttributes.markerId}`
        );

        const circleMarker: SVGCircleElement = this.renderer.createElement(
          "circle",
          "svg"
        );
        this.renderer.setAttribute(
        ...
        this.renderer.setAttribute(
          circleMarker,
          "visibility",
          this.lineAttributes.markerVisibility
        );
        this.renderer.setStyle(
          circleMarker,
          "fill",
          this.lineAttributes.stroke
        );
