...
describe("EraserCommand", () => {
  ...
  beforeEach(() => {
    ...
    const polyline: SVGElement = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "polyline"
    );
    ...
    polyline.setAttribute(
      "style",
      "fill: none; stroke: rgb(0, 0, 0); stroke-width: 8px; stroke-opacity: 1;"
    );
    ...
    const marker: SVGMarkerElement = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "marker"
    );
    ...
    domSpy = spyOn(document, "getElementById").and.returnValue(
