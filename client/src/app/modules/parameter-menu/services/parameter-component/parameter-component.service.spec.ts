...
import { SelectionToolParameterComponent } from "src/app/modules/tool-parameters";
...
describe("ParameterComponentService", () => {
  ...
  it("parameter-component service should be created", () => {
    const service: ParameterComponentService = TestBed.get(
      ParameterComponentService
    );
